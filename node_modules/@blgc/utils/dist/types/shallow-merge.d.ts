 ...
 */
export declare function shallowMerge<TTarget extends Record<string, unknown>, TSource extends Record<string, unknown>>(target: TTarget, source: TSource, overwriteUndefinedProperties?: boolean): TTarget & TSource;
